...
[![Maintained by duanlanqunshan](https://img.shields.io/badge/Maintained%20by-duanlanqunshan-blue.svg)](https://github.com/duanlanqunshan/Unitale)
...
Version 1.5.1 update: Improved by duanlanqunshan. Loosened the LLM SFX annotation rules, added few-shot examples for ambient, interval, and silent scenes, normalized SFX names and positions, and now lets unmatched SFX fall back to realistic keywords for LLM redirection and Freesound retrieval, raising overall SFX coverage. Project homepage: https://github.com/duanlanqunshan/Unitale
