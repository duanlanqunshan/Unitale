...
1.5.1版本更新：由 duanlanqunshan 完善音效识别链路——放宽 LLM 音效标注规则、补全持续/间隔/静默等场景的 Few-shot 示例、归一化 SFX 名称与位置字段、本地音效库未命中时改由写实关键词进入 LLM 重定向与 Freesound 兜底，提升整体 SFX 覆盖率。项目主页：https://github.com/duanlanqunshan/Unitale
